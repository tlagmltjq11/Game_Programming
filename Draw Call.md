...
안돼요. 해상도 문제를 고려해야한다. 512 해상도의 텍스쳐 16개를 합치면 2048 해상도의 텍스쳐가 필요하다.<br>
...
**드로우콜 수를 줄이기 위해 오브젝트들을 합쳐 내부적으로 하나의 메시로 만들어준다.**<br>
...
1개의 메시만 사용하더라도 여러 개의 메시를 합친, 거대한 메시를 만들기 위한 추가 메모리가 필요한 것이다.<br>
...
하지만 **런타임상에 배칭처리를 해야되기 때문에 제약사항이 많다.**<br>
